      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              Upload your insurance documents and get step-by-step guidance on filing your claim quickly and easily.
            </p>
          </button>
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              Tell us about your situation and receive personalized insurance recommendations tailored to your needs.
            </p>
          </button>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-500">
            Powered by AI • Secure & Private • Always Available
          </p>
        </div>
      </div>
    </div>
